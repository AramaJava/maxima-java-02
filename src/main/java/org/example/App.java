...
public class App
{
    public static void main( String[] args )
    {
        ...
        City City1 = new City("Сургут",100, true, false);
        City City3 = new City("Омск",100);
        ...
        if ((log1.getShipping(City1, 200, 2)) != null) {
            System.out.println("Оптимальный транспорт для города "+ City1.getName() + " - "  + (log1.getShipping(City1, 200, 2)).getName() + "с ценой "+ (log1.getShipping(City1,200, 2)).getPrice(City1) );
        } else System.out.println("Оптимального транспорта нет!");
